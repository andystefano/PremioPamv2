  	...
  	<header>
		...
		<div style="background-color:#E9D9FC !important;position: relative;top: -4px; display: inline-block; width: 100%; height: auto; ">
		  <div class="cuerpo contenido"> 
			...
			<h2><!--VOTO PUBLICO--></h2>
			<h1>Un reconocimiento a mujeres artistas.</h1>
...
if($NUMERO==61){
	...
	?>
		<a href="https://www.youtube.com/watch?v=wcIjxqhYUSo" target="_blank"><img class="lazyload ImgPrincipal" id="ImgPrincipal_<?php echo $ID_POSTULACION; ?>" data-id="<?php echo $ID_POSTULACION; ?>" data-anterior="" data-siguiente="" data-actual="<?php echo $FOTO_SELECCION; ?>" data-ruta="/media/<?php echo $ID_POSTULACION; ?>/"  data-imagenes="<?php echo $fotos; ?>" src="/media/<?php echo $ID_POSTULACION; ?>/<?php echo $FOTO_SELECCION; ?>.jpg" /></a>
	...
	?>
		...
		<a href="https://www.youtube.com/watch?v=tvFgIwHM8KY&t=9s" target="_blank"><img class="lazyload ImgPrincipal" id="ImgPrincipal_<?php echo $ID_POSTULACION; ?>" data-id="<?php echo $ID_POSTULACION; ?>" data-anterior="" data-siguiente="" data-actual="<?php echo $FOTO_SELECCION; ?>" data-ruta="/media/<?php echo $ID_POSTULACION; ?>/"  data-imagenes="<?php echo $fotos; ?>" src="/media/<?php echo $ID_POSTULACION; ?>/<?php echo $FOTO_SELECCION; ?>.jpg" /></a>
...
<div> &gt; &gt; </div>
				...
				<h3><b>Ciudad</b>: <?php echo ((str_replace("@","",utf8_encode($LUGAR_RESIDENCIA)))); ?>.</h3>
				<br/>
...
<div id="Votar" title="Votación">
  ...
  <img id="VotarCerrar2" src="/img/close.png" style="max-width: 50px; margin-right: 30px;">
